...
export default function Dashboard() {
  ...
  return (
    <>
      <Head>
        <title>SDSU Student Experience Dashboard</title>
        <meta name="description" content="Interactive dashboard for visualizing SDSU student living experiences, mental health, and campus community data." />
